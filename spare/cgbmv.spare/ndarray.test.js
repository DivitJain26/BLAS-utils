...
// cgbmv_ndarray( 'no-transpose', 3, 3, 1, 1, alpha, A, 3, 1, 0, x, 1, 0, beta, y1, 1, 0 );
// console.log( "row-major", y1.toString() );

// cgbmv_ndarray( 'no-transpose', 3, 3, 1, 1, alpha, A, 1, 3, 0, x, 1, 0, beta, y2, 1, 0 );
...
// var y = new Complex64Array( [ 1.0, 1.0, 2.0, 2.0, 3.0, 3.0 ] );
// var alpha = new Complex64( 0.5, 0.5 );
// var beta = new Complex64( 0.5, -0.5 );

// cgbmv_ndarray( 'no-transpose', 3, 3, 1, 1, alpha, A, 3, 1, 0, x, -1, 2, beta, y, -1, 2 );
