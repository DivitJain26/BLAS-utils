const chemv = require('@stdlib/blas/base/chemv/lib/chemv.js');
...
function runBaseTest(name, data) {
  ...
  const out = chemv( data.order, data.uplo, data.N, alpha, a, data.lda, x, data.strideX, beta, y, data.strideY );
