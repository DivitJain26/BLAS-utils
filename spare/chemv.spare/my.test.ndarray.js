const chemv = require('@stdlib/blas/base/chemv/lib/ndarray.js');
...
function runNdarrayTest(name, data) {
  ...
  const beta = new Complex64(data.beta[0], data.beta[1]);
	...
	const out =	chemv( data.uplo, data.N, alpha, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX, beta, y, data.strideY, data.offsetY );
