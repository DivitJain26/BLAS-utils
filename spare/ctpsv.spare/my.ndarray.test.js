const ctpsv = require('../lib/base.js');
...
function runNdarrayTest(name, data) {
  ...
  const out = ctpsv( data.order, data.uplo, data.trans, data.diag, data.N, ap, data.strideAP, data.offsetAP, x, data.strideX, data.offsetX );
