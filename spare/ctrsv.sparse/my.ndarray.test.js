const ctrsv = require('../lib/base.js');
...
function runNdarrayTest(name, data) {
  ...
  const out = ctrsv( data.uplo, data.trans, data.diag, data.N, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX );
